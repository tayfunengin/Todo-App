...
export interface ITodoItemsClient {
    ...
    softDelete(command: SoftDeleteTodoItemCommand): Observable<FileResponse>;
}
...
export interface ITodoListsClient {
    ...
    delete(id: number): Observable<FileResponse>;
    softDelete(command: SoftDeleteTodoListCommand): Observable<FileResponse>;
}
...
export class TodoListsClient implements ITodoListsClient {
    ...
    softDelete(command: SoftDeleteTodoListCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/TodoLists/SoftDelete";
        url_ = url_.replace(/[?&]$/, "");
...
export class SoftDeleteTodoItemCommand implements ISoftDeleteTodoItemCommand {
    id?: number;

    constructor(data?: ISoftDeleteTodoItemCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SoftDeleteTodoItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new SoftDeleteTodoItemCommand();
        result.init(data);
        return result;
    }
...
export interface ISoftDeleteTodoItemCommand {
    id?: number;
}
...
export class SoftDeleteTodoListCommand implements ISoftDeleteTodoListCommand {
    id?: number;

    constructor(data?: ISoftDeleteTodoListCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SoftDeleteTodoListCommand {
        data = typeof data === 'object' ? data : {};
        let result = new SoftDeleteTodoListCommand();
        result.init(data);
        return result;
    }
...
export interface ISoftDeleteTodoListCommand {
    id?: number;
}
